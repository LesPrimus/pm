...
All 10 parts in [docs/PLAN.md](docs/PLAN.md) are done. Sign in with `user` / `password`, the Kanban board
persists to SQLite, and the chat sidebar answers questions about the board and edits it through OpenRouter.
